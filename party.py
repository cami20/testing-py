...
def is_mel(name, email):
    ...
    >>> is_mel('melitpolski mel', 'mel@ubermelon.com')
    True
    ...
    mels_name = ['mel', 'melitpolski']
    name = name.split(' ')
    return (name[0].lower() in mels_name and name[1].lower() in mels_name) or email.lower() == "mel@ubermelon.com"
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'appetizer'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'dessert')
